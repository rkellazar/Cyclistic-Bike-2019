...
#### Differentiating Average Ride Length of Casual Riders and Annual Members
...
knitr::include_graphics("casual_rider_avgLength.png")

knitr::include_graphics("member_rider_avgLength.png")
...
knitr::include_graphics("rtrips_casual.png")

knitr::include_graphics("rtrips_member.png")
...
In this analysis, the data is grouped into four quarters. And to ensure that the data is reliable, it is filtered out for rides with a length greater than 60 seconds but less than 24 hours.

When analyzing the data, it is found that casual riders tend to ride for about 66% longer than annual members. On all days of the week, the average ride length of casual riders is significantly longer than that of annual members. However, there were relatively few bike trips taken by casual riders during the first and fourth quarters. In contrast, throughout the entire quarter and on all days of the week, the number of bike trips taken by annual members exceeds that of casual riders.

## Recommendations

- A promo that can save casual riders more for riding longer
- They should put some kind of promotion in the top 6 most visited bike station
- Q2 to Q3 should be the date where there is more promotion because Casual Riders rides more by that month.
